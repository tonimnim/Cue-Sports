...
Future<void> createTournaments(
  ...
  final tournaments = [
    ...
    },
    {
      ...
      'description':
          'Professional level tournament for advanced players with live streaming.',
...
Future<void> createMatchScores(
  ...
  for (final score in scores) {
    final docRef = firestore.collection('match_scores').doc();
...
Future<void> createLiveMatches(FirebaseFirestore firestore, DateTime now,
  ...
  for (final liveMatch in liveMatches) {
    final docRef = firestore.collection('live_matches').doc();
...
Future<void> createRefereeAssignments(
  ...
  for (final assignment in assignments) {
    final docRef = firestore.collection('referee_assignments').doc();
...
Future<void> createTournamentAnnouncements(
  ...
  for (final announcement in announcements) {
    final docRef = firestore.collection('tournament_announcements').doc();
...
Future<void> createTournamentSchedules(
  ...
  for (final schedule in schedules) {
    final docRef = firestore.collection('tournament_schedules').doc();
...
Future<void> createLiveStreams(
  ...
  for (final stream in streams) {
    final docRef = firestore.collection('live_streams').doc();
